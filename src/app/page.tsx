...
const MAX_AUDIO_BYTES = 4.5 * 1024 * 1024; // ~4.5 MB (Vercel limit)
            ...
            {summary && (
              <div style={S.resultBox}>
                ...
                <div style={{ display: "flex", gap: 6, marginTop: 10 }}>
                  <button onClick={() => speak(summary)} style={{ ...S.bigBtn("#27272a", "2px solid #3f3f46"), flex: 1, color: "#facc15" }}>
                    <Volume2 style={{ width: 18, height: 18 }} /> 🔊 LEER
                  </button>
                  {subtitleText && (
